.. _mapping-3_biquadratic-exchange:

********************
Biquadratic exchange
********************

Bilinear exchange involves four entities (two entities per site).
Therefore, it can be expressed via the term :math:`\mathcal{H}_{0, 4}`.
