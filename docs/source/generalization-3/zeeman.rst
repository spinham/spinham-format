...
.. list-table::
    ...
    *   - :math:`\mathcal{H}`
        ...
        - .. math::
            ...
            \mathbf{S}_i
    *   - Indices renaming
        - :math:`i \rightarrow (\mu_1, \alpha_1)`, :math:`i_1, j_1 = x, y, z`
        - :math:`n \rightarrow (\mu_1, \alpha_1)`, :math:`\alpha \rightarrow i_1` and :math:`\alpha \rightarrow j_1`
        - :math:`n \rightarrow (\mu_1, \alpha_1)`, :math:`\alpha \rightarrow i_1` and :math:`\alpha \rightarrow j_1`
        - :math:`i \rightarrow (\mu_1, \alpha_1)`, :math:`i_1, j_1 = x, y, z`
        - :math:`i \rightarrow (\mu_1, \alpha_1)`, :math:`i_1, j_1 = x, y, z`
    *   - :math:`C_{1, 1}`
    ...
    *   - :math:`V_{1; \mu_1; \alpha_1}^{j_1, i_1}`
        - :math:`\mu_B g_{\mu_1, \alpha_1} \delta_{j_1, i_1}`
        - :math:`g_{\mu_1, \alpha_1} \mu_B \delta_{j_1, i_1}`
        - :math:`\mu_B \delta_{j_1, i_1}`
        - :math:`\mu_{\mu_1, \alpha_1} \delta_{j_1, i_1}`
        - :math:`\mu_B g_{\mu_1, \alpha_1} \delta_{j_1, i_1}`
    *   - :math:`Y_{1}^{j_1}`
        - :math:`H^{j_1}`
        - :math:`H^{j_1}`
