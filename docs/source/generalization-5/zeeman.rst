...
Zeeman interaction involves two entities. Therefore, it can be expressed as a
...
.. list-table::
    ...
    *   - :math:`V_{\mu_1, \mu_2; \alpha_1, \alpha_2}^{i_1, i_2}`
        - :math:`\mu_B g_{\mu_2, \alpha_2} \delta_{i_1, i_2} \delta_{\mu_1, \mu_2} \delta_{\alpha_1, \alpha_2}`
        - :math:`g_{\mu_2, \alpha_2} \mu_B \delta_{i_1, i_2} \delta_{\mu_1, \mu_2} \delta_{\alpha_1, \alpha_2}`
        - :math:`\mu_B \delta_{i_1, i_2} \delta_{\mu_1, \mu_2} \delta_{\alpha_1, \alpha_2}`
        - :math:`\mu_{\mu_2, \alpha_2} \delta_{i_1, i_2} \delta_{\mu_1, \mu_2} \delta_{\alpha_1, \alpha_2}`
        - :math:`\mu_B g_{\mu_2, \alpha_2} \delta_{i_1, i_2} \delta_{\mu_1, \mu_2} \delta_{\alpha_1, \alpha_2}`
